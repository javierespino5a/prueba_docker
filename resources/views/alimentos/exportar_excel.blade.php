            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Capturas apoyo Alimentos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Apoyo alimentos</a></li>
                            <li class="breadcrumb-item active">apoyo alimentos</li>
                        </ol>
                        <form action="{{ action('AlimentosController@exportar_excel') }}" method="post">
